...
partial class PipeWrench : HLWeapon
{
	...
	public override string ViewModelPath => "models/of/weapons/view/v_pipe_wrench.vmdl";
	...
	public override void AttackPrimary()
	{
		...
		if ( !didHit )
		{
			PlaySound( "sounds/of/weapons/pwrench_miss.sound" );
		}
		else
		{
			PlaySound( "sounds/of/weapons/pwrench_miss.sound" );
			...
			if ( hitEntity != this && hitEntity is NPC && IsServer )
			{
				...
				{
					PlaySound( "sounds/of/weapons/pwrench_hitbod.sound" );
					if ( ( hitEntity as NPC ).BloodColour == NPC.BLOOD_COLOUR_RED )
					{
			...
			{
				using ( Prediction.Off() )
					PlaySound( "sounds/of/weapons/pwrench_hit.sound" );
			}
		}
