public class HLMovementBrush : BrushEntity, IUse
{
	...
	public void ApplyPush( Entity lastTouch, bool push )
	{
		...
		if ( lastTouch is HLPlayer ply && lastTouch.GroundEntity != this )
		{
			...
			temp.x = temp.x + playerMover.WishVelocity.x * factor;
			temp.y = temp.y + playerMover.WishVelocity.y * factor;
			...
			if ( playerTouch )
			{
				...
				var temp2 = playerMover.Velocity;
				temp2.x = temp.x;
				temp2.y = temp.y;
				playerMover.Velocity = temp2;
				ply.Velocity = temp2;
			}
